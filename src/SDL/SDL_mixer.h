...
static inline Mix_Music* Mix_LoadMUS(const char* file) { (void)file; return nullptr; }
...
static inline Mix_Chunk* Mix_LoadWAV(const char* file) { (void)file; return nullptr; }
