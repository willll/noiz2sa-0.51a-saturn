...
void drawTitle()
{
  static constexpr int kTitleSpriteCount = 7;
  static constexpr int kOriginalVideoWidth = 640;
  static constexpr int kOriginalLayerWidth = 320;
  static constexpr int kOriginalTitleVideoX = 162;
  static constexpr int kOriginalTitleVideoY = 16;
  static constexpr int kOriginalTitleStep = 46;
  static constexpr int kOriginalLayerOffsetX = (kOriginalVideoWidth - kOriginalLayerWidth) / 2;

  for (int i = 0; i < kTitleSpriteCount; i++)
  {
    drawSprite(
        i,
        (kOriginalTitleVideoX - kOriginalLayerOffsetX + i * kOriginalTitleStep) / SCREEN_DIVISOR,
        kOriginalTitleVideoY / SCREEN_DIVISOR);
  }
}
