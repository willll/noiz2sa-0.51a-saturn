...
Options:
  ...
  --skip-run                              Skip running emulator (requires existing logs/uts_background.log)
  --log <path>                            Path to uts_background.log (default: <repo>/logs/uts_background.log)
...
LOG_FILE="$ROOT_DIR/logs/uts_background.log"
