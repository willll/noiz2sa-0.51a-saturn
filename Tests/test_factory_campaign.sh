...
Options:
  ...
  --skip-run                              Skip running emulator (requires existing logs/uts_factory.log)
  --log <path>                            Path to uts_factory.log (default: <repo>/logs/uts_factory.log)
...
LOG_FILE="$ROOT_DIR/logs/uts_factory.log"
