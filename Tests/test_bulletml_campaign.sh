...
Options:
  ...
  --skip-run                              Skip running emulator (requires existing Tests/uts_bulletml.log)
  --log <path>                            Path to uts_bulletml.log (default: <repo>/Tests/uts_bulletml.log)
...
SKIP_RUN=0
STRICT=0
LOG_FILE="$ROOT_DIR/Tests/uts_bulletml.log"
